...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomRep_RefHdle;                    /**< envoi_rep_definition handle */
  uint16_t  CustomMovement_RecordHdle;                  /**< Movement_record_ref handle */
...
/* USER CODE BEGIN PFP */
/* acc_serv */
static void Custom_Axex_Update_Char(void);
static void Custom_Axex_Send_Notification(void);
/* USER CODE END PFP */
 ...
 */
#define COPY_ENVOI_REP_DEFINITION_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x00,0xcc,0x7a,0x48,0x2a,0x98,0x4a,0x7f,0x2e,0xd5,0xb3,0xe5,0x8f)
#define COPY_MOVEMENT_RECORD_REF_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xab,0xcd,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch (blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
          ...
          } /* if (attribute_modified->Attr_Handle == (CustomContext.CustomMovement_RecordHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))*/
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   * service_max_attribute_record = 1 for envoi_rep_definition +
   *                                2 for Movement_record_ref +
   *                                1 for Movement_record_ref configuration descriptor +
   *                              = 4
   *
